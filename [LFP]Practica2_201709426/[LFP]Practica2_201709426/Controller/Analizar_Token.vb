Public Class Analizar_Token
    ...
    Public Function analizador(lista_token As List(Of Token), anexo As Integer) As ArrayList
        ...
        While lista_token(index).getNumero <> 999
            ...
            If lista_token(index).getLexema = "public" Then
                If declarada = False Then
                    declarar_clase()
                    tnt = 1
                ElseIf m_principal = False Then
                    metodo_principal()
                    tnt = 1
                End If
            End If
    ...
    Public Sub sentencia_if()
        ...
        If lista_token(index).getLexema = "(" Then
            incrementar()
        Else
            capturar_error("se esperaba parentesis")
        End If
        If lista_token(index).getLexema = "int" Then
            incrementar()
        ElseIf lista_token(index).getNumero = 17 Then
            asignar()
        Else
            capturar_error("se esperaba la palabra reservada")
        End If
    End Sub
    ...
    Public Sub comentario_linea()
        ...
        End If
        Try
            Dim fila_sig = lista_token(index).getFila + 1
    ...
    Public Sub declarar_clase()
        ...
        End If
        If lista_token(index).getNumero = 17 And lista_token(index).getTipo <> "" Then
            incrementar()
        Else
    ...
    Public Sub declarar_numero()
        ...
        While lista_token(index).getLexema <> ";"
            ...
            If lista_token(index).getNumero = 17 Then
                cambio = 1
                If lista_token(index - 1).getLexema = "int" Then
                    ...
                    incrementar()
                Else
                    If buscar_variable(tipo) = True Then
                        id = lista_token(index).getLexema
                        temporal = id
                        incrementar()
                    Else
            ...
            ElseIf lista_token(index).getTipo = "int" Or lista_token(index).getTipo = "double" Then
                id = temporal
            Else
                capturar_error("Se esperaba el nombre de la variable")
                Exit While
            End If
            If lista_token(index).getLexema = "," Then
                incrementar()
